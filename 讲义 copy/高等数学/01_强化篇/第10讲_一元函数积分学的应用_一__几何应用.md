...
$$
\lim_{n \to \infty} \left(2 \sum_{k=1}^{n} A_k\right)^n = \lim_{n \to \infty} \left[\sum_{k=1}^{n}\left(\frac{2}{k+1}-\frac{2}{k+2}\right)\right]^n = \lim_{n \to \infty}\left(1-\frac{2}{n+2}\right)^n = \mathrm{e}^{-2}
$$
