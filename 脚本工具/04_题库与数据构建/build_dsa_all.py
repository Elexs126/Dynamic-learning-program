# -*- coding: utf-8 -*-
"""
Precise Builder for 王道数据结构 课后选择题 (8 Chapters, 644 MCQs)
"""

import os
import re
from dsa_img_map import dsa_page_images

BASE_DIR = r"c:\Users\HP\Documents\antigravity\delightful-salk\王道计算机考研408\03_数据结构_选择题"
...
# Define all sections in Data Structure
sections_info = [
    # Chapter 1
    ...
    # Chapter 2
    {"ch": "第2章 线性表", "file": "第02章_线性表.md", "sec": "2.1 线性表的定义和基本操作", "regex": r"2\.1\s*线性表的定义和基本操作"},
    ...
    {"ch": "第3章 栈、队列和数组", "file": "第03章_栈_队列和数组.md", "sec": "3.4 数组和特殊矩阵", "regex": r"3\.4\s*数组和特殊矩阵"},
    # Chapter 4
    ...
    # Chapter 8
    {"ch": "第8章 排序", "file": "第08章_排序.md", "sec": "8.1 排序的基本概念", "regex": r"8\.1\s*排序的基本概念"},
...
def parse_questions_in_section(sec_text):
    ...
    for i, m in enumerate(q_matches):
        ...
        for qp in sorted(set(all_pages)):
            if qp in dsa_page_images:
                for img_name in dsa_page_images[qp]:
                    q_images.append(f"![题图及相关图表代码](../../images/dsa/{img_name})")
...
print(f"\nAll Data Structure chapters generated! Total questions: {total_dsa_questions}")
