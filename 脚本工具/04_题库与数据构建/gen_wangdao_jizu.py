...
def save_file(rel_path, title, intro, content):
...
save_file(
    "01_计算机组成原理_选择题/第01章_计算机系统概述.md",
    "《王道计算机组成原理》· 第1章 计算机系统概述（课后选择题全解）",
    "本章包含 1.2 计算机系统层次结构 (14题) 与 1.3 计算机性能指标 (20题)，共计 34 道经典选择题与统考真题。",
    ch1_content
)

print("Finished Part 1 Chapter 1")
