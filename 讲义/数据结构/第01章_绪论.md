<!-- DIRECTED-REPAIR-FALLBACK:FALLBACK-DS-CH1-P13-OMITTED-CHAPTER-OPENING -->
> [!WARNING]
> 原 PDF 第 13 页回退：分章从 1.1 页中段起切，章名、考纲、知识框架和复习提示整块漏失；现有 Markdown 无法安全恢复版式与全部内容。

![原 PDF 第 13 页回退](../_directed_repair_assets/FALLBACK-DS-CH1-P13-OMITTED-CHAPTER-OPENING_pdf_p0013.png)
...
<!-- DIRECTED-REPAIR-FALLBACK:FALLBACK-QA-DS-CH1-P17-CODE-BLOCK -->
> [!WARNING]
> 原 PDF 第 17 页回退：顺序查找示例的四行 C 代码被压成“算法执行频度与时间复杂度递推展开”等占位文字，无法从现有 Markdown 安全恢复。

![原 PDF 第 17 页回退](../_directed_repair_assets/FALLBACK-QA-DS-CH1-P17-CODE-BLOCK_pdf_p0017.png)

时间复杂度通常用大O记号表示：若存在正常数C和 $n _ { 0 }$ ，使得对所有 $n   \geq   n _ { 0 }$ 时，都有
...
<!-- DIRECTED-REPAIR-FALLBACK:FALLBACK-408-CAND_8f8f6428a34b03d4 -->
> [!WARNING]
> 原 PDF 第 22 页回退：递归基例if(n<=1) return 1在多行被识别为字母l和向下箭头，表格整体多处损坏。；物理页22确认整张表的重复代码；源表多格同时损坏，局部替换会遗漏，应整表回填。

![原 PDF 第 22 页回退](../_directed_repair_assets/FALLBACK-408-CAND_8f8f6428a34b03d4_pdf_p0022.png)
