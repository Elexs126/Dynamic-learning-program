...
(2)当 $p = 5 0$ 元时，销量 $Q = 10000$ 件， $L^{\prime}(10000)=20$ 元.
...
(1)设 $R = R(p)$ 为总收益函数，证明 $\frac{\mathrm{d}R}{\mathrm{d}p}=Q(1-\eta)$ 作为结论用>已说明，若无说明，则以Q为自变量

(2)当p=6时，求总收益对价格的弹性，并说明其经济意义.

分析①写出R(p)，再对p求导，代入η即可；

②写出 $\frac { E R } { E p }$ ，代入 $\eta = \frac{2p^{2}}{192 - p^{2}}\bigg|_{p = 6}$ 即可.   
6
