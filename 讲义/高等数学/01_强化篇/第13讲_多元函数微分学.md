...
<!-- DIRECTED-REPAIR-MOVE:A-MOVE-HIGH-CH13-OPENING-READING-ORDER -->
↓ ①联系联想与一元的 形式②区别本质
...
$$
\begin{aligned}\lim\limits_{(x, y) \to (x_0, y_0)} f(x, y) &= A \quad \text{或} \quad \lim\limits_{\substack{x \to x_0 \\ y \to y_0}} f(x, y) = A, \\\lim\limits_{P \to P_0} f(P) &= A.\end{aligned}
$$
