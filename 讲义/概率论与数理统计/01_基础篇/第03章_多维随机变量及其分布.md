...
<!-- DIRECTED-REPAIR-FALLBACK:FALLBACK-PROB-BASE-CH3-P54-JOINT-DISTRIBUTION-TABLE -->
> [!WARNING]
> 原 PDF 第 54 页回退：二维离散型随机变量联合分布律示意表的省略号、行列标题和 p_ij 单元格多处丢失或错位。

![原 PDF 第 54 页回退](../../_directed_repair_assets/FALLBACK-PROB-BASE-CH3-P54-JOINT-DISTRIBUTION-TABLE_pdf_p0054.png)
...
<!-- DIRECTED-REPAIR-FALLBACK:FALLBACK-QA-R2-PROB-BASE-CH03-P59-DIST -->
> [!WARNING]
> 原 PDF 第 59 页回退：0-1分布表结构破坏,1/2成1-2

![原 PDF 第 59 页回退](../../_directed_repair_assets/FALLBACK-QA-R2-PROB-BASE-CH03-P59-DIST_pdf_p0059.png)
...
$$
P\left\{ Y \leq \frac{1}{2} \mid X \leq \frac{1}{2} \right\} = \frac{P\left\{ X \leq \frac{1}{2}, Y \leq \frac{1}{2} \right\}}{P\left\{ X \leq \frac{1}{2} \right\}} = \frac{\iint\limits_{\substack{x \leq \frac{1}{2}\\y \leq \frac{1}{2}}} f(x,y) \mathrm{d}x \mathrm{d}y}{\iint\limits_{x \leq \frac{1}{2}} f(x,y) \mathrm{d}x \mathrm{d}y} = \frac{\int_{0}^{\frac{1}{2}} \mathrm{d}y \int_{\frac{y}{2}}^{\frac{1}{2}} 1 \mathrm{d}x}{\int_{0}^{\frac{1}{2}} \mathrm{d}x \int_{0}^{2x} 1 \mathrm{d}y} = \frac{\frac{3}{16}}{\frac{1}{4}} = \frac{3}{4}.
$$
...
【例】设随机变量X与Y独立，其中X的概率分布为 $X \sim \begin{pmatrix} 1 & 2 \\ 0.3 & 0.7 \end{pmatrix}$ ，而Y的概率密度为 $f(y)$ ,求随机变
