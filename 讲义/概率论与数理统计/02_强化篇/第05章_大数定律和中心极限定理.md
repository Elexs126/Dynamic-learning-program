...
后解重由题意知二相互独文同分布，且均服从

$$
X_{_i} \sim \begin{pmatrix}
1 & 2 & 3 & 4 & 5 & 6 \\
\dfrac{1}{6} & \dfrac{1}{6} & \dfrac{1}{6} & \dfrac{1}{6} & \dfrac{1}{6} & 
\end{pmatrix},
$$

<!-- DIRECTED-REPAIR-FALLBACK:FALLBACK-PROB-ADV-CH5-P216-DAMAGED-DICE-DISTRIBUTION -->
> [!WARNING]
> 原 PDF 第 216 页回退：例5.4的解析引导语被推广水印切碎，骰子分布律末项1/6漏失；二维分布表与相邻文字不能仅靠候选长行安全恢复。

![原 PDF 第 216 页回退](../../_directed_repair_assets/FALLBACK-PROB-ADV-CH5-P216-DAMAGED-DICE-DISTRIBUTION_pdf_p0216.png)
...
后续更随机变量x有机相互独立，服从相同的分布，具有数学期望 $E(X_n) = \mu$ 和方差 $D(X_{n}) = \sigma^{2}$ 
...
P { X ≤ 240} = P X-200 V 240-200 ≈Φ(2). 20 20  
